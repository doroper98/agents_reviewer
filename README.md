...
## Status
- Version: v2.4.1 (SSOT: `src/orchestrator.py:VERSION`)
...
- **v2.5.0** 분석 용어 학부생 수준화 + 분석 시각 풀 확장 + 균형 분석 4단락
- **v2.4.0** AI 소비용 Markdown 보고서 export
- **v2.4.0-pre** 모든 테마 텍스트 대비 개선
- **v1.x** 6막 극장 구조 정착, SVG/Canvas 시각화 (DEVLOG §9)
