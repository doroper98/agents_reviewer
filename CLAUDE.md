...
- Visualization: d3 v7 SVG 차트 (composer-emitted inline data, **29종 type** (v8.6.2) — v5.3.0 FT/Economist 7종 + sankey + v7.0.0 bump/bullet/connected_scatter 3종 + v7.5.0 combo/diverging_bar/pyramid/dot_matrix 4종 + v8.6.2 treemap/tree 2종. v7.9.17 network 폐기 CHART-AP-36)
...
- **29종 type** (v8.6.2 — treemap/tree 추가. v7.9.17 network 폐기 CHART-AP-36):
