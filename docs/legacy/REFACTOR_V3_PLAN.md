...
ssot_for: []
depends_on:
  - "(historical) DOCS_GOVERNANCE_V3.md"
  - "(historical) src/orchestrator.py:VERSION"
last_review: 2026-04-26
moved_to_legacy: 2026-05-05
moved_by: "REFACTOR_V5_PLAN.md Phase 0 (Baseline + SSOT Repair)"
---

# [LEGACY] Agents Reviewer — V3 Refactoring Master Plan

> **본 문서는 *legacy* 로 분류됩니다.** v3 시대의 7-agent / 11-lens / 11-archetype / 5-gate 마스터 플랜의 *역사적 SSOT* 였으나, v4.0.0 부터 본 plan 의 흐름은 호출되지 않습니다. 현재 시스템은 [docs/ARCHITECTURE.md](../ARCHITECTURE.md) (v4.5.7) 가 SSOT, V5 리팩토링은 [REFACTOR_V5_PLAN.md](../../REFACTOR_V5_PLAN.md) 가 SSOT 입니다.
>
> 본 문서는 보존 목적으로 `docs/legacy/` 에 이전되었으며 (REFACTOR_V5_PLAN.md Phase 0 의 SSOT Repair 작업), 본문 수정은 더 이상 진행되지 않습니다. 코드 잔존 (`src/lenses/`, `src/agents/{player,dynamics,...}.py`, `src/templates/blocks/` 등) 의 *역사적 설계 이유* 를 추적할 때만 참조하시기 바랍니다. root 의 [REFACTOR_V3_PLAN.md](../../REFACTOR_V3_PLAN.md) 는 깊은 링크 호환을 위한 redirect stub 입니다.

# Agents Reviewer — V3 Refactoring Master Plan (원문 보존)
