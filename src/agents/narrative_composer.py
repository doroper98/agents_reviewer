...
SYSTEM_PROMPT = (
    ...
    "  ```json\n"
    "  {\n"
    '    \"type\": \"bar|donut|line|gantt|stacked|bubble|heatmap|dual_line|forecast|choropleth|candle|area|scatter|stacked_area|lollipop|slope|small_multiples|waterfall|range_bar|sankey|bump|bullet|connected_scatter|combo|diverging_bar|pyramid|dot_matrix|stakeholder_map|treemap|tree\",\n'
    '    \"title\": \"차트 제목\",\n'
