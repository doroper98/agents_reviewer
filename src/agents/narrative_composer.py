...
_REPORTAGE_BLOCK = (
    ...
    "\n"
    "[감시신호 제거] watch_signals 는 *빈 배열* 로 둔다 ([]). 르포는 말미의 감시신호\n"
    "epilogue 를 두지 않는다 — 전망은 5막의 서사로 대신한다. contradictions(쟁점/반대\n"
    "관점)는 그대로 유지·권장한다 (내막에는 대립하는 해석이 따르기 마련이다).\n"
    "\n"
    "[그 외] 다른 모든 사실 규율·문체·시점 앵커링·기호 금지 규칙은 그대로 적용된다.\n"
